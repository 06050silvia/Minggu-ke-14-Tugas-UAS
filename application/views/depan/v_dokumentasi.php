...
<div class="row">
  <div class="col-md-12">
    <h3 class="gallery-style">Dokumentasi Kami</h3>
  </div>
</div><br>
<div class="row">
  <div class="col-md-12">
    <div id="gallery">
      <div id="gallery-content">
        <div id="gallery-content-center">
          <?php foreach ($all_dokumentasi->result() as $row) : ?>
            <a href="<?php echo base_url().'assets/images/'.$row->dokumentasi_gambar;?>" class="image-link2">
             <img src="<?php echo base_url().'assets/images/'.$row->dokumentasi_gambar;?>" class="all img-fluid" alt="#" />
            </a>
          <?php endforeach;?>
       </div>
     </div>
